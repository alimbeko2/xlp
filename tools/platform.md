...
<<<<<<< HEAD
XLP操作工具可以按照使用用途的不同，可分为目标管理工具、项目管理、工具、数据管理工具、开发管理工具、出版管理工具、展示管理工具等。
=======
<<<<<<< HEAD
xlp工具按照使用用途的不同，可分为目标管理工具、项目管理工具、数据管理工具、开发管理工具、出版管理工具、展示管理工具等。
=======
xlp工具按照使用用途的不同，可分为**目标管理工具**、**项目管理工具**、**数据管理工具**、**开发管理工具**、**出版管理工具**、**展示管理工具**等。
>>>>>>> 2bd577dfbf33efccf67759bbae72dbb295c473d4
>>>>>>> 9788ba4e96dce4c35007a715ea756234653a460f
